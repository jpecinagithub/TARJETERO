      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-slate-600">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Nombre del Archivo</p>
            ...
            {item.tags && item.tags.length > 0 && (
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.tags.map((tag) => (
                    <span key={tag} className={`px-3 py-1 rounded-lg text-sm font-medium ${isPdf ? 'bg-red-50 text-red-700' : 'bg-blue-50 text-blue-700'}`}>
                      {tag}
                    </span>
                  ))}
                </div>
          ...
          <div className="bg-slate-900 p-6 rounded-3xl text-white shadow-xl shadow-slate-200">
            <h4 className="font-bold mb-2">Modo Offline</h4>
            <p className="text-slate-400 text-sm leading-relaxed">
              Este documento ha sido cacheado. Puedes volver a consultarlo incluso sin conexión a internet.
            </p>
          </div>
        </div>
      </div>
